...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Suruks632', auth_plugin='mysql_native_password')
...
if selected == "Contact":
    name = "SURESH KUMAR"
    mail = (f'{"Mail :"}  {"suruks632@gmail.com@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/suruks9",
        "LINKEDIN": "https://github.com/suruks9/BizCardX-Extracting-Business-Card-Data-with-OCR"}

 

    st.title('BizCardX: Extracting Business Card Data with OCR')
    st.write("BizCardX is to automate and simplify the process of capturing and managing contact information from business cards, saving users time and effort. It is particularly useful for professionals who frequently attend networking events, conferences, and meetings where they receive numerous business cards that need to be converted into digital contacts.")
    st.write("---")
    st.subheader(name)
    st.subheader(mail)
